...
int main(int argc, char** argv) {
  ...
  auto field_default_values =
      fromAddr<Il2CppFieldDefaultValue>(metadata, header->fieldDefaultValuesOffset);
  auto field_default_values_size =
      header->fieldDefaultValuesCount / sizeof(Il2CppFieldDefaultValue);
